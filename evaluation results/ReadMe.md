This folder contains all the evaluation materials regarding the generated UML Component Diagrams across four architectural settings. 
...
Field values for eval.xlsx:
  ...
  Criterion:
      ...
      uml_adherence = Adherence to UML Standard
      clarity = Clarity / Degree of Understandability
      terminology = Terminological Alignment with Requirements
      style_adherence = Adherence to Architectural Style
  Value:
      1 = Not fulfilled
      2 = Minimally fulfilled
